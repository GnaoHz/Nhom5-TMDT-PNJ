          ...
          child: Column(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Món quà tuyệt vời cho tình yêu của bạn',
                  style: TextStyle(
                    fontSize: 24,
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    CachedNetworkImage(
                      imageUrl:
                          'https://firebasestorage.googleapis.com/v0/b/duan-4904c.appspot.com/o/flutter_pnj%2FImage%20Home%2FImage%20B%E1%BB%99%20s%C6%B0u%20t%E1%BA%ADp%2FBosuutap_Onlyyou.png?alt=media&token=39ff59eb-d3e8-45d3-9d2a-d54cdaaf32fd',
                    ...
                    const Padding(
                      ...
                      child: Text(
                        ' Bộ sưu tập lấy cảm hứng từ "Only You",với hình ảnh chữ O và U lồng ghép vào nhau tạo thành biểu tượng tinh tế, khéo léo mang vào thiết kế để tạo nên chiếc nhẫn cầu hôn với ý nghĩa đặc biệt: Chỉ trao tình yêu duy nhất một đời.',
                        style: TextStyle(
                          fontSize: 12,
                          color: Color(0xff131118),
                          fontFamily: 'Inter',
                    ...
                    CachedNetworkImage(
                      imageUrl:
                          'https://firebasestorage.googleapis.com/v0/b/duan-4904c.appspot.com/o/flutter_pnj%2FImage%20Home%2FImage%20trang%20s%E1%BB%A9c%2FTrangsuc_nhan.png?alt=media&token=71f900cb-5a5a-416a-a344-1b47e9a596dc',
                      // width: double.infinity,
                      height: 106,
                      // fit: BoxFit.cover,
                      placeholder: (context, url) => const Center(
                    ...
                    Padding(
                      ...
                      child: BassicButtonInter(
                        onPressed: () {
                          Get.to(() => const CollectionProduct(
                        ...
                        colorButton: const Color(0xffAC3843),
                        height: 44,
                        radius: 5,
                      ),
                    ),
                    ...
                    Column(
                      children: [
                        ...
                        CachedNetworkImage(
                          imageUrl:
                              'https://firebasestorage.googleapis.com/v0/b/duan-4904c.appspot.com/o/flutter_pnj%2FScreenshot%202025-02-26%20152938.png?alt=media&token=9090aaba-a778-4c7e-965c-75e8ebd95b66',
                          width: double.infinity,
                          // height: 200,
                          fit: BoxFit.fill,
                          placeholder: (context, url) => const Center(
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              border: Border.all(
                                  width: 1, color: const Color(0xffFFBEC4))),
                          child: Column(
                            children: [
                              const SizedBox(
                                height: 80,
                              ...
                              const Padding(
                                ...
                                child: Text(
                                  'Tình yêu là sự rung động từ trái tim, là những khoảnh khắc đáng trân quý mà ta luôn muốn gìn giữ.Bộ sưu tập Chót Mê ra đời như một cách tôn vinh cảm xúc chân thành, giúp bạn gửi gắm những lời yêu thương sâu sắc qua từng thiết kế trang sức tinh xảo.',
                                  style: TextStyle(
                                    fontSize: 12,
                                    color: Color(0xff131118),
                                    fontFamily: 'Inter',
                  ...
                  children: [
                    ...
                    Align(
                      alignment: Alignment(0,
                          0.2), // Căn giữa theo chiều ngang, dịch xuống một chút
                      child: Column(
                        children: [
                          const SizedBox(
                            height: 250,
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    CachedNetworkImage(
                      imageUrl:
                          'https://firebasestorage.googleapis.com/v0/b/duan-4904c.appspot.com/o/flutter_pnj%2FScreenshot%202025-02-26%20162938.png?alt=media&token=4a37cf34-db96-4180-a203-9e7e3af4fb10',
                      width: double.infinity,
                      // height: 200,
                      fit: BoxFit.fill,
                      placeholder: (context, url) => const Center(
                      ...
                      child: Column(
                        children: [
                          ...
                          const Padding(
                            padding: EdgeInsets.symmetric(horizontal: 24),
                            child: Text(
                              'Tỏa sáng với những thiết kế tinh xảo từ PNJ, được chế tác từ vàng, kim cương và đá quý cao cấp. Mỗi đôi bông tai không chỉ tôn vinh nét thanh lịch mà còn là biểu tượng của sự sang trọng và đẳng cấp, giúp bạn luôn rạng rỡ trong mọi khoảnh khắc.',
                              style: TextStyle(
                                fontSize: 12,
                                color: Color(0xff131118),
                                fontFamily: 'Inter',
              ...
              Container(
                ...
                child: Column(
                  children: [
                      ...
                      child: Column(
                        children: [
                          ...
                          const Padding(
                            padding: EdgeInsets.symmetric(horizontal: 24),
                            child: Text(
                              'Khám phá ngay những combo trang sức PNJ với thiết kế tinh xảo, kết hợp hoàn hảo giữa nhẫn, bông tai, dây chuyền và lắc tay. Sở hữu vẻ đẹp sang trọng với mức giá hấp dẫn, giúp bạn tỏa sáng trong mọi dịp đặc biệt!',
                              style: TextStyle(
                                fontSize: 12,
                                color: Color(0xff131118),
                                fontFamily: 'Inter',
                    ...
                    CachedNetworkImage(
                      imageUrl:
                          'https://firebasestorage.googleapis.com/v0/b/duan-4904c.appspot.com/o/flutter_pnj%2FScreenshot%202025-02-26%20164336.png?alt=media&token=3462d822-26a1-499a-aeab-c86e79d02d47',
                      width: double.infinity,
                      // height: 200,
                      fit: BoxFit.fill,
                      placeholder: (context, url) => const Center(
